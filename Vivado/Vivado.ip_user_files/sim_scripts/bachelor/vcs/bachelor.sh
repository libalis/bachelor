...
#
# Script generated by Vivado on Sat Mar 15 19:46:48 CET 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bachelor.sh
...
#
# Usage        : bachelor.sh
#                bachelor.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bachelor.sh [-reset_run]
#                bachelor.sh [-reset_log]
#                bachelor.sh [-help]
#
...
#                script (type 'bachelor.sh -help' for more information).
#
...
# script info
echo -e "bachelor.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bachelor.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../Vivado.gen/sources_1/bd/bachelor/ipshared/3cbc" +incdir+"../../../../Vivado.gen/sources_1/bd/bachelor/ipshared/814a/hdl/verilog" +incdir+"../../../../Vivado.gen/sources_1/bd/bachelor/ipshared/1017/hdl/verilog" +incdir+"../../../../Vivado.gen/sources_1/bd/bachelor/ipshared/4506/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bachelor xil_defaultlib.glbl -o bachelor_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bachelor_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/robert/Downloads/Bachelor/Vivado/Vivado.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key bachelor_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bachelor_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bachelor.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bachelor.sh [-help]\n\
Usage: bachelor.sh [-step]\n\
Usage: bachelor.sh [-lib_map_path]\n\
Usage: bachelor.sh [-reset_run]\n\
Usage: bachelor.sh [-reset_log]\n\
Usage: bachelor.sh [-keep_index]\n\
Usage: bachelor.sh [-noclean_files]\n\n\
