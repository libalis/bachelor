...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Vivado.gen/sources_1/bd/bachelor/ipshared/3cbc" +incdir+"../../../../Vivado.gen/sources_1/bd/bachelor/ipshared/814a/hdl/verilog" +incdir+"../../../../Vivado.gen/sources_1/bd/bachelor/ipshared/1017/hdl/verilog" +incdir+"../../../../Vivado.gen/sources_1/bd/bachelor/ipshared/4506/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bachelor xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bachelor -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/robert/Downloads/Bachelor/Vivado/Vivado.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bachelor_sc.so .tmp_log xcelium_lib waves.shm c.obj)
