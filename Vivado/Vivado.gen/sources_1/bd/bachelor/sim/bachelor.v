...
module bachelor
  ...
  wire matrix_vector_clock_1;
  wire matrix_vector_reset_1;
  ...
  assign matrix_vector_clock_1 = matrix_vector_clock;
  assign matrix_vector_reset_1 = matrix_vector_reset;
  bachelor_MATRIX_VECTOR_0_0 MATRIX_VECTOR_0
       (.matrix_vector_clock(matrix_vector_clock_1),
        ...
        .matrix_vector_reset(matrix_vector_reset_1),
  ...
  bachelor_UART_TRANSMITTER_0_0 UART_TRANSMITTER_0
       (.uart_transmitter_clock(matrix_vector_clock_1),
  ...
  bachelor_vio_0_0 vio_0
       (.clk(matrix_vector_clock_1),
        ...
        .probe_in4(UART_TRANSMITTER_0_uart_transmitter_output),
