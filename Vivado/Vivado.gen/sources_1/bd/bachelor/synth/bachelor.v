...
(* CORE_GENERATION_INFO = "bachelor,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bachelor,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_board_cnt=4,da_clkrst_cnt=4,synth_mode=None}" *) (* HW_HANDOFF = "bachelor.hwdef" *) 
module bachelor
   (matrix_vector_clock);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.MATRIX_VECTOR_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.MATRIX_VECTOR_CLOCK, CLK_DOMAIN bachelor_matrix_vector_clock_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input matrix_vector_clock;
