...
HD_PWD='/home/robert/Downloads/Bachelor/Vivado/Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bachelor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bachelor_wrapper.tcl -notrace
